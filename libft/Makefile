...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/03/08 22:43:34 by olboothe          #+#    #+#              #
#    Updated: 2019/03/20 20:20:16 by olboothe         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_memccpy.c ft_memset.c ft_putnbr_fd.c ft_strcmp.c ft_striteri.c ft_strncat.c ft_strrchr.c ft_toupper.c ft_countwords.c ft_intlen.c ft_lst_reverse.c ft_swap.c ft_lstaddback.c ft_strarrmax.c ft_wordcount.c
...
ft_memccpy.o ft_memset.o ft_putnbr_fd.o ft_strcmp.o ft_striteri.o ft_strncat.o ft_strrchr.o ft_toupper.o ft_countwords.o ft_intlen.o\
ft_lst_reverse.o ft_swap.o ft_lstaddback.o ft_strarrmax.o ft_wordcount.o
